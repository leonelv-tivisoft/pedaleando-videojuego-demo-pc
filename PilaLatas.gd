...
@onready var PilaLatas: StaticBody3D = self
@onready var OutLineMesh: MeshInstance3D = $"Crashed Tin Can_004/MeshInstance3D"
...
func _process(_delta: float) -> void:
	...
	if PilaLatas:
		PilaLatas.position.y = (OutLineWidth if selected else 0.0)
